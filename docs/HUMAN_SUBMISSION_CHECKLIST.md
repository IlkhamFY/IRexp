...
Critical submit blockers below are done. Optional human checks remain open. Do not invent values.
...
| # | Action | Status |
|---|---|---|
| 6 | Expert human structure spot-check n≥100 | ☐ deferred |
| 7 | Human extraction-recall mark-up (paper-level) | ☐ deferred |
| 8 | Commercial-DoR human audit is complete at n=161; do not discuss the unscored NC*/SA queue in the manuscript | ☑ |
