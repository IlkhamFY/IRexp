...
co-reported $^{1}$H/$^{13}$C NMR strings on the row, shown beside a PubChem 3D conformer of the resolved structure (CID 23966138).
...
(commercial DoR) with a PubChem 3D conformer of the resolved structure (CID 23966138).
\label{lst:example}
\vspace{0.35em}
\noindent
