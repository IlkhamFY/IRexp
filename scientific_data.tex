...
spectroscopic models and elucidation pipelines that need structured, attributable experimental peak
...
the commercial Hugging Face dataset of record.
...
\begin{itemize}
  ...
  \item Commercial F2/F3 flags --- done (flag-only; 18,651 / 3,154 / union 21,075
        of 88,545).
  \item \textbf{161 scored} on the commercial Hugging Face dataset of record
