...
(cm$^{-1}$) mined from PMC13029360, with resolved SMILES, SELFIES, and InChIKey
encodings, co-reported $^{1}$H/$^{13}$C NMR strings, licence-join fields, and
a ball-and-stick 3D view of the structure.
...
with a ball-and-stick 3D view of the resolved structure.
\label{lst:example}
...
\begin{lstlisting}[style=irexpjson]
{
  ...
  "selfies": "[C][O][C][=C][C][=C][Branch1][=N][N][C][=Branch1][C][=O][N][C][C][C][C][Ring1][Ring2][C][=C][Ring1][=C]",
...
\centering
\includegraphics[width=\linewidth]{fig_example_mol3d.pdf}
\end{minipage}
\end{figure}
